...
const projects = [
    {
        ...
        functionality: ['Create and login to accounts', 'Create characters with name, description, and stats', 'View past characters', 'Update character stats'],
    ...
    },
    {
        ...
        functionality: ['Create and login to accounts', 'Create code snippets to post', 'View code snippets posted by all users', 'Bookmark code snippets', 'View your bookmarked snippets', 'View the most bookmarked snippets on the site'],
    ...
    },
    {
        ...
        functionality: ['Search crypto currency by name or symbol', 'Choose from top three search results', 'Get the top three most relevant articles about the crypto currency', 'Search data is saved and remain after leaving the site'],
    ...
    },
    {
        ...
        date: '',
        category: 'front-end',
        description: 'Slate is a custom CSS framework made from scratch.',
        infoSegments: [],
        functionality: [''],
        frontEndTech: [],
        backEndTech: [],
